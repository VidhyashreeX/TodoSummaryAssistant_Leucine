      ...
      <div className="flex items-center justify-between">
        {!summary ? (
          ...
          <button 
            ...
            className="px-4 py-2 bg-secondary text-white rounded-lg shadow-sm hover:bg-violet-600 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSendingToSlack ? (
              <>
